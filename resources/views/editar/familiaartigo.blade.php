...
<div class="box box-success">
      <div class="box-header with-border">
            <h3 class="box-title">EDITAR UMA FAMíLIA DE ARTIGO</h3>
      </div>
      {!! Form::open(array('route' => ['familiaartigos.update','id'=>$familiaartigo->pk_familiaartigos],'method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
      <div class="row">
      ...
      <div class="box-body">
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::text('descricao',$familiaartigo->descricao,['class'=>'form-control','required'=>'required']) !!}
