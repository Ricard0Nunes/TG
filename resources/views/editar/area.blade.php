...
<div class="box box-success">
      <div class="box-header with-border">
            <h3 class="box-title">EDITAR UMA ÁREA</h3>
      </div>
      {!! Form::open(array('route' => ['area.update',$area->pk_area],'method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
      <div class="row">
      ...
      <div class="box-body">
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::text('area',$area->projArea,['class'=>'form-control','required'=>'required']) !!}
