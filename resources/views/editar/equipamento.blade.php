      ...
      <div class="box box-success">
            ...
            <div class="box-body">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('codigo',$equipamento->codigo,['class'=>'form-control','required'=>'required','placeholder'=>'Código do Equipamento']) !!}
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('nSerie',$equipamento->nSerie,['class'=>'form-control','placeholder'=>'Nº de Série do Equipamento']) !!}
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('fatura',$equipamento->fatura,['class'=>'form-control','placeholder'=>'Nº de Fatura']) !!}
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('observacoes',$equipamento->observacoes,['class'=>'form-control','placeholder'=>'Especificações e outras observações do equipamento']) !!}
