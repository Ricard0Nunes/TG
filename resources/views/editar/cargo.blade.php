...
@section('content')
      <div class="box box-success">
            <div class="box-header with-border">
                  <h3 class="box-title">EDITAR UM CARGO</h3>
            </div>
            {!! Form::open(array('route' => ['cargo.update',$cargo->pk_cargo],'method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
            <div class="row">
            ...
            <div class="box-body">
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('descricao',$cargo->descricao,['class'=>'form-control','required'=>'required','placeholder'=>'Descrição do Cargo']) !!}
