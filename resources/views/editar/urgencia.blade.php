      ...
      <div class="box box-success">
            ...
            <div class="box-body">
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('descricaoUrgencia',$urgencia->descricaoUrgencia,['class'=>'form-control','required'=>'required']) !!}
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-sm-5">
                              {!! Form::text('pesoUrgencia',$urgencia->pesoUrgencia,['class'=>'form-control','required'=>'required']) !!}
