...
<script>setTimeout(function(){window.location.href = "/picar";}, 60000);</script>
...
<div id="scheduler_here" class="dhx_cal_container" style='width:100%; height:100%;'>
   ...
   <div class="dhx_cal_navline">
       ...
       <div class="dhx_dummy dhx_cal_today_button" style='right:200px' > <a  href="{{ url('picar') }}"><button type="button" style="" id="edit-item"class="btn btn-large btn-success btn-flat">Voltar
       </button></a> </div>
       {{-- <div class="dhx_dummy dhx_cal_today_button" style='right:220px' onclick='scheduler.addEventNow()'>Adicionar </div> --}}
   </div>
