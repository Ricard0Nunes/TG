...
<div class="box box-widget widget-user-2" style="background-color:transparent">
        <!-- Add the bg color to the header using any of the bg-* classes -->
        <div class="widget-user-header bg-green"  style="padding:-10px;border-radius:10px; background-color:#40a431 !important; border-top: 5px solid #307a25 !important;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)!important;">
          <div class="box-body" style="background-color:rgba(255,255,255,0.3)!important;border-radius:20px;">
            
      
            <div class="row" style="padding:15px;">
                <div class="col-xs-12 col-md-4">
                    <div class="widget-user-image ">
                        <img class=" img-responsive" src="{{asset($user->foto)}}"alt="User Avatar">
                      </div>
                      <!-- /.widget-user-image -->
                    <h3 class="widget-user-username ">{{$user->name}}</h3>
                    <h5 class="widget-user-desc">{{$cargo}}-{{$departamento}}</h5>
