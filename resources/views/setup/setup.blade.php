...
<style>body {
      ...
      @keyframes textHidden {
        ...
        <div class="has-animation animation-rtl" data-delay="1000">
          <p class="text">
              O Software TurtleGest, desenvolvido pela empresa TurtleDestiny, permite ao utilizador a fácil gestão da sua empresa, controlo de acesso dos trabalhadores, analíses de performance entre outras funcionalidades, mediante a aquisição do módulo correspondente.
          </p>
        </div>
        <br>
        <br>
        ...
        <div class="has-animation animation-rtl" data-delay="2000">
          <img src="logo.png" style="" width="600" />
        </div> <br><br>
        <div class="has-animation animation-ltr" data-delay="6000">
                <p class="botao">   <a href="setup2"><button class="btn " style="background-color:#40a431; border:1px solid black; color:white;">Começar</button></a></p>
