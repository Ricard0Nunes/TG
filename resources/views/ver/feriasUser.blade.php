...
@section('title', 'Férias')
    ...
    <style type="text/css">
        body,html{height:100%;padding:0;margin:0}.dhx_after div,.dhx_before div{color:transparent!important;border-right:transparent}.dhx_before.month_start div{border-right:1px solid #cecece!important}.dhx_after div,.dhx_before div{color:transparent!important;border-right:transparent}td:nth-child(6) .dhx_month_head{background-color:#cacaca!important;color:#000!important}td:nth-child(7) .dhx_month_head{background-color:#cacaca!important;color:#000!important}.dhx_cal_event div.dhx_footer,.dhx_cal_event.event_1 div.dhx_footer,.dhx_cal_event.event_2 div.dhx_footer,.dhx_cal_event.event_3 div.dhx_footer,.dhx_cal_event.event_4 div.dhx_footer,.dhx_cal_event.event_5 div.dhx_footer,.dhx_cal_event.event_6 div.dhx_footer,.dhx_cal_event.event_7 div.dhx_footer,.dhx_cal_event.event_8 div.dhx_footer,.dhx_cal_event.event_9 div.dhx_footer,.dhx_cal_event.past_event div.dhx_footer{background-color:transparent!important}.dhx_cal_event .dhx_body{-webkit-transition:opacity .1s;transition:opacity .1s;opacity:.7}.dhx_cal_event .dhx_title{line-height:12px}.dhx_cal_event.dhx_cal_select_menu .dhx_body,.dhx_cal_event.selected .dhx_body,.dhx_cal_event:hover .dhx_body,.dhx_cal_event_line:hover{opacity:1}.dhx_cal_event.event_1 div,.dhx_cal_event_line.event_1{background-color:#40a431!important;border-color:#307a25!important}.dhx_cal_event.dhx_cal_editor.event_1{background-color:#ff5722!important}.dhx_cal_event_clear.event_1{color:#40a431!important}.dhx_cal_event.event_2 div,.dhx_cal_event_line.event_2{background-color:#1a4998!important;border-color:#04245a!important}.dhx_cal_event.dhx_cal_editor.event_2{background-color:#ff5722!important}.dhx_cal_event_clear.event_2{color:#1a4998!important}.dhx_cal_event.event_3 div,.dhx_cal_event_line.event_3{background-color:#9575cd!important;border-color:#681f8c!important}.dhx_cal_event.dhx_cal_editor.event_3{background-color:#ff5722!important}.dhx_cal_event_clear.event_3{color:#9575cd!important}.dhx_cal_event.event_4 div,.dhx_cal_event_line.event_4{background-color:#00aff0!important;border-color:#2b5464!important}.dhx_cal_event.dhx_cal_editor.event_4{background-color:#ff5722!important}.dhx_cal_event_clear.event_4{color:#00aff0!important}.dhx_cal_event.event_5 div,.dhx_cal_event_line.event_5{background-color:#eb4e4e!important;border-color:#c71919!important}.dhx_cal_event.dhx_cal_editor.event_5{background-color:#ff5722!important}.dhx_cal_event_clear.event_5{color:#eb4e4e!important}.dhx_cal_event.event_6 div,.dhx_cal_event_line.event_6{background-color:#e33486!important;border-color:#ce0c67!important}.dhx_cal_event.dhx_cal_editor.event_6{background-color:#ff5722!important}.dhx_cal_event_clear.event_6{color:#e33486!important}.dhx_cal_event.event_7 div,.dhx_cal_event_line.event_7{background-color:#ffa406!important;border-color:#ff7e00!important}.dhx_cal_event.dhx_cal_editor.event_7{background-color:#ff5722!important}.dhx_cal_event_clear.event_7{color:#ffa406!important}.dhx_cal_event.event_8 div,.dhx_cal_event_line.event_8{background-color:#705438!important;border-color:#5f3f1f!important}.dhx_cal_event.dhx_cal_editor.event_8{background-color:#ff5722!important}.dhx_cal_event_clear.event_8{color:#705438!important}.dhx_cal_event.event_9 div,.dhx_cal_event_line.event_9{background-color:#d0be0a!important;border-color:#d0be0a!important}.dhx_cal_event.dhx_cal_editor.event_9{background-color:#ff5722!important}.dhx_cal_event_clear.event_9{color:#d0be0a!important}
    </style>
                ...
                <form id="edit-form" class="form-horizontal" method="POST" action="/gravarcontacto"> <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <div class="card text-white bg-dark mb-0">
                        <div class="card-header">
                            <h2 class="m-0">Legenda Calendário</h2>
              </div>
              <div class="card-body">
                  <div class="row">
                    <div class="col-md-4"></div>
                    <div class="col-md-8 align-center">              <button type="button" style="background-color:#40a431!important;border-color:#307a25!important"class="btn btn-primary">Férias</button>
                      
                        <button type="button"style="background-color:#eb4e4e!important;border-color:#c71919!important " class="btn btn-primary">Feriado</button>
                        <button type="button"style=" background-color:#cacaca!important;border-color:black!important; color:black !important;" class="btn btn-primary">Fim de Semana</button>
                    </div>
...
<div id="scheduler_here" class="dhx_cal_container" style='width:100%; height:100%;'>
   <div class="dhx_cal_navline">
       ...
       <div class="hidden">
      {{$empresa=  DB::connection('geraltg')->table('empresascomuns')->where('NIF',$user->nifEmpregador)->value('nomeCompleto')}}
      {{$ano= date('Y')}}
      
       </div>
       <div class="dhx_dummy dhx_cal_today_button" style='right:350px' >     <input value="Exportar para PDF" type="button" onclick='scheduler.exportToPDF({name:"MapaFérias_{{$user->sigla}}_{{$ano}}.pdf",  format:"A4", orientation:"portrait",header:"<style>     .dhx_before div, .dhx_after div{olor:transparent !important;  border-right:transparent;}.dhx_before.month_start div{       border-right:1px solid #CECECE !important;}        .dhx_before div, .dhx_after div{ color:transparent !important; border-right:transparent; } td:nth-child(6) .dhx_month_head{background-color: #cacaca !important ; color:black !important;}   td:nth-child(7) .dhx_month_head{background-color: #cacaca !important ; color:black !important;  }</style> <h1>Mapa de Férias {{$ano}} - {{$user->name}}</h1><br><h5>{{$empresa}}</h5>",footer:"<br><small>Assinatura Direcção</small> <br><br><p>___________________________________________________________</p>" });'>
       </div>
       @if(Auth::user()->fk_departamento ==3)
    <div class="dhx_dummy dhx_cal_today_button" style='right:450px' > <a href="{{URL('colaboradores')}}"><button type="button"  style="background-color:transparent !important; border-color: transparent !important; font-size:20px !important;" class="btn btn-large btn-success btn-flat"><i style="color:#40a431 !important;"class="fas fa-users"></i>
       </button></a> </div>
       @endif
       <div class="dhx_dummy dhx_cal_today_button" style='right:200px' > <button type="button" style="background-color:transparent !important; border-color: transparent !important; font-size:20px !important;" id="edit-item"class="btn btn-large btn-success btn-flat"><i style="color:#40a431 !important;"class="fas fa-info-circle"></i>
       </button> </div>
        ...
        (function() {
            ...
            scheduler._mark_year_date = function(date, event) {
                ...
                if (!scheduler._year_marked_cells[dateString]) {
                    ...
                    if(event.subject == 5){
                        cell.setAttribute("style", "background-color:#eb4e4e");
                    }
                    if(event.subject == 9){
                        cell.setAttribute("style", "background-color:#d0be0a");
                    }
                    if(event.subject == 1){
                        cell.setAttribute("style", "background-color:#40a431");
                    }
...
<script type="text/javascript">
            ...
            scheduler.load("/api/ferias", "json"); 
       
    
            var dp = new dataProcessor("/api/ferias"); 
            dp.init(scheduler);
