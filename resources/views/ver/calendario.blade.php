...
border-right:1px solid #CECECE !important;
   ...
   td:nth-child(6) .dhx_month_head{background-color: #cacaca !important ; color:black !important;}
   td:nth-child(7) .dhx_month_head{background-color: #cacaca !important ; color:black !important;  }
            ...
            <div class="card text-white bg-dark mb-0">
              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-md-9">              <button type="button" style="background-color:#40a431!important;border-color:#307a25!important"class="btn btn-primary">Férias</button>
                        <button type="button" style=" background-color:#1a4998!important;border-color:#04245a!important" class="btn btn-primary">Ausência</button>
                        <button type="button"style=" background-color:#9575CD!important;border-color:#681f8c!important" class="btn btn-primary">Reunião</button>
                        <button type="button"style=" background-color:#00aff0!important;border-color:#2b5464!important" class="btn btn-primary">Call Skype</button>
                        ...
                        <button type="button"style=" background-color:#e33486!important;border-color:#ce0c67!important" class="btn btn-primary">Deslocação</button>
                        <button type="button" style="background-color:#ffa406!important;border-color:#ff7e00!important "class="btn btn-primary">Formação</button>
                        <button type="button" style=" background-color:#705438!important;border-color:#5f3f1f!important"class="btn btn-primary">Outros</button></div>
...
<div id="scheduler_here" class="dhx_cal_container" style='width:100%; height:100%;'>
   ...
   <div class="dhx_cal_navline">
       ...
       <div class="dhx_dummy dhx_cal_today_button" style='right:300px' onclick='scheduler.addEventNow()'>Adicionar </div>
   </div>
...
scheduler.config.hour_size_px = 88;
            ...
            scheduler.locale.labels.section_localizacao = "Localização";
			...
			var subject = [
                ...
                { key: '3', label: 'Reunião' },
				{ key: '4', label: 'Call Skype' },
                // { key: '6', label: 'Deslocação' },
				// { key: '7', label: 'Formação' },
				// { key: '8', label: 'Outros' }
			];
     
            // var list = scheduler.serverList("users",[]).slice();

			scheduler.config.lightbox.sections=[
                { name: "users", height: 100, map_to: "fk_tecnico", type: "multiselect", options: 
                scheduler.serverList("users"), vertical:true
                },
				{name:"description", height:25, map_to:"text", type:"textarea" , focus:true},
                {name:"observacoes", height:60, map_to:"obs", type:"textarea" , focus:true},
                {name:"localizacao", height:25, map_to:"localizacao", type:"textarea" , focus:true},
				{name:"subject", height:35, type:"select", options: subject, map_to:"subject" },
            ...
            // scheduler.load("/api/usersEvent",function(){

            //     scheduler.updateCollection("users", list);
                // scheduler.showLightbox(2);
    //         var usersEvent = scheduler.parse(loader.responseText);
    // scheduler.serverList("users");
    // scheduler.render();
    // });
