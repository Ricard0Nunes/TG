...
<div class="box box-success">
   ...
   {!! Form::open(array('route' => 'lead.store','method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
   <div class="row">
   ...
   <div class="box-body">
         ...
         <div class="box-body" style="">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-5">
                  {!! Form::select('fk_potencialcliente', $potencialcliente, null, ['class' => 'form-control','placeholder' => 'Escolha o Potencial Cliente']) !!}
