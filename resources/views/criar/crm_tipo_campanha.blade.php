...
<div class="box box-success">
   <div class="box-header with-border">
      <h3 class="box-title">CRIAR UM TIPO DE CAMPANHA</h3>
   </div>
   {!! Form::open(array('route' => 'tipo_campanha.store','method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
   <div class="row">
      ...
      <div class="box" style="border-top:0px solid black!important">
         ...
         <div class="box-body" style="">
            <div class="form-group">
               ...
               <div class="col-sm-5">
                  {!! Form::text('tipoCampanha',null, ['class' => 'form-control','required'=>'required']) !!} 
                  {!! $errors->first('tipoCampanha','
