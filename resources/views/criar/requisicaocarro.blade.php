...
<div class="box box-success">
      <div class="box-header with-border">
            <h3 class="box-title">CRIAR UMA REQUISIÇÃO</h3>
      </div>
      {!! Form::open(array('route' => 'requisicaocarro.store','method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
      <div class="row">
      ...
      <div class="box-body">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::date('dataPartida',null,['class'=>'form-control','required'=>'required']) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::time('partidaPrevista',null,['class'=>'form-control','required'=>'required']) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::time('chegadaPrevista',null,['class'=>'form-control','required'=>'required']) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::text('rota',null,['class'=>'form-control','required'=>'required','placeholder' => 'Local Partida-Destino-Local Partida' ]) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::select('ocupantes[]', $users, null, array('class' => 'form-control', 'id'=>'departamento',  'multiple'=>'multiple','placeholder' => 'Sem Ocupantes')) !!}
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-5">
                        {!! Form::select('fk_veiculo', $veiculo,null,array('class' => 'form-control', 'id'=>'fk_veiculo','required'=>'required', 'placeholder' => 'Escolha o Veículo' )) !!}
