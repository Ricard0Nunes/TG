...
{{-- 
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
                    ...
                    <div class="col invoice-to">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                {!! Form::open(array('route' => 'venda.store','method'=>'POST','files'=>'true','class'=>'form-horizontal')) !!}
                                <div class="form-group">
                                    {!! Form::label('fk_cliente','Cliente',['class'=>'col-sm-2 control-label']) !!}
                                    <div class="col-sm-5">
                                          {!! Form::select('fk_cliente',$clientes,null,['class'=>'form-control','placeholder'=>'Escolha o Cliente','required'=>'required']) !!}
                                          {!! $errors->first('fk_cliente','<p class="alert alert-danger">:message</p>')!!}
                                    </div>
                                    <button type="submit" class="btn btn-success "> <i class="far fa-check-circle"></i> Validar
            ...
            <footer>
                Esta venda foi processada através do Turtlegest, pelo utilizador: {{DB::table('users')->where('id',auth::id())->value('name')}} 
            </footer>
<br><br>
