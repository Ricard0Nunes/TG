...
{{-- 
    ...
    <div class="invoice overflow-auto">
        <div style="min-width: 600px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="col invoice-details">
                                    <h1 class="invoice-id">Encomenda Nº:{{$ultimacompra}}</h1>
            ...
            <footer>
                Esta encomenda foi processada através do Turtlegest, pelo utilizador: {{DB::table('users')->where('id',auth::id())->value('name')}} 
            </footer>
            <br>
