            ...
            @endif
                ...
                <div class="navbar-custom-menu">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="" style="padding:15px; color:white"><span>
                        <a  id="relogio" style="color:inherit"></a> - {{$data}}</span>
...
{{$idUser= auth()->user()->id}}
                                  ...
                                  <img src="{{auth()->user()->foto}}" class="user-image" alt="User Image">
                                    <span class="hidden-xs">{{auth()->user()->name}} ( {{$empresa2}})</span>
                                </a>
                                <ul class="dropdown-menu">
                                  ...
                                  <li class="user-footer">
                                    <div class="pull-left">
                                      <a href="veruser/{{$idUser}}" class="btn btn-default btn-flat">Profile</a>
                                    </div>
