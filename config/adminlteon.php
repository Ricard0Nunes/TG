            ...
            [
                ...
                'submenu' => [
                    [
                        ...
                        'icon'    => 'fas  fa-users',
                        'url'     => 'colaboradores',
                        'active'    => ['colaboradores','criarcolaborador'],
                     ],
                     [
                        'text' => 'Cargos',
                        'icon'    => 'fas fa-user-graduate',
                        'url'     => 'cargos',
                        'active'    => ['cargos','editarcargo/*','novocargo'],
                         ...
                         [
                            ...
                            'icon'    => 'fas fa-users',
                            'url'     => 'departamentos',
                            'active'    => ['/departamentos','/novodepartamento'],
                ...
                'submenu' => [
                    [
                     ...
                     [
                        ...
                        'icon'    => 'fas fa-laptop',
                        'url'     => 'equipamentos',
                        'active'    => ['/equipamentos', 'novoequipamento','editarequipamento'],
